...
?>
<div class="giiant-crud jurusan-index">
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Data <?= Yii::t('app', 'Jurusans') ?></h3>
    </div>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if ($rel = $model->getFakultas0()->one()) {
                                return Html::a($rel->nama_fakultas, ['fakultas/view', 'id' => $rel->id,], ['data-pjax' => 0]);
                            } else {
                                return '';
                            }
                        },
