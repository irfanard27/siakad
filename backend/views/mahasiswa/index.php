...
<div class="giiant-crud mahasiswa-index">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Data <?= Yii::t('app', 'Mahasiswas') ?></h3>
        </div>
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->getFakultas0()->one()) {
			            return Html::a($rel->id, ['fakultas/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
			...
			[
			    ...
			    'value' => function ($model) {
			        if ($rel = $model->getJurusan0()->one()) {
			            return Html::a($rel->id, ['jurusan/view', 'id' => $rel->id,], ['data-pjax' => 0]);
			        } else {
			            return '';
			        }
			    },
