...
?>
<div class="giiant-crud nilai-index">
            ...
            [
                ...
                'dropdown' => [
                    ...
                    'items' => [[
                        ...
                        'label' => '<i class="fa fa-arrow-right">&nbsp;' . 'Mata Kuliah' . '</i>',
                    ], [
                        'url' => ['mahasiswa/index'],
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Data <?= Yii::t('app', 'Nilais') ?></h3>
    </div>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if ($rel = $model->getMahasiswa0()->one()) {
                                return Html::a($rel->nimrn, ['mahasiswa/view', 'id' => $rel->id,], ['data-pjax' => 0]);
                            } else {
                                return '';
                            }
                        },
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if ($rel = $model->getMataKuliah()->one()) {
                                return Html::a($rel->mata_kuliah, ['mata-kuliah/view', 'id' => $rel->id,], ['data-pjax' => 0]);
                            } else {
                                return '';
                            }
                        },
