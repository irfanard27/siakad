...
?>
<div class="giiant-crud mata-kuliah-index">
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">Data <?= Yii::t('app', 'MataKuliahs') ?></h3>
    </div>
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if ($rel = $model->getIdJurusan()->one()) {
                                return Html::a($rel->nama_jurusan, ['jurusan/view', 'id' => $rel->id,], ['data-pjax' => 0]);
                            } else {
                                return '';
                            }
                        },
